...
public class BillingServiceMediatorTest {
    ...
    public void shouldUseBillingServiceToChargeFeeAndSendSMSAndStartDefaultedBillSchedule_InCaseOfErrors() {
        ...
        assertDefaultBillingRequest(
                new DefaultedBillingRequest(mobileNumber, programType, now.dayOfMonth().addToCopy(7 + Week.days + 1).withTimeAtStartOfDay().withHourOfDay(DEFAULTED_SUBSCRIPTION_BILLING_HOUR), Week,
