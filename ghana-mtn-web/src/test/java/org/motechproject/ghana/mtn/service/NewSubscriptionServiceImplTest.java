...
import org.motechproject.ghana.mtn.service.process.SubscriptionBilling;
import org.motechproject.ghana.mtn.service.process.SubscriptionCampaign;
import org.motechproject.ghana.mtn.service.process.SubscriptionPersistence;
import org.motechproject.ghana.mtn.service.process.SubscriptionValidation;

import static junit.framework.Assert.assertEquals;
import static org.mockito.Mockito.*;
import static org.mockito.MockitoAnnotations.initMocks;

public class NewSubscriptionServiceImplTest {
    ...
    public void shouldCallAllProcessInvolvedOnNoErrorsDuringStartSubscription() {
        ...
        when(parser.parse(inputMsg)).thenReturn(subscription);
