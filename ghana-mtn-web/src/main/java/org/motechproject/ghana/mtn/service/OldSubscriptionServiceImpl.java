...
@Service
public class OldSubscriptionServiceImpl {
    private final static Logger log = Logger.getLogger(OldSubscriptionServiceImpl.class);
    ...
    private void billingAndStartMonthlySchedule(String subscriberNumber, Subscription subscription) {
        ...
        sendSms(subscriberNumber, subscription.getProgramType(), String.format(message(BILLING_SUCCESS), response.getValue().amountChargedWithCurrency()));
    }
